...
# lightly modified for GKG by Andrew Halterman, ahalterman@caerusanalytics.com
...
def get_daily_data(directory, unzip=False):
    ...
    month = now.month
    day = now.day
    url = '%04d%02d%02d.gkg.csv.zip' % (year, month, day)
    get_url = 'http://gdelt.utdallas.edu/data/gkg/{}'.format(url)
